...
Usage:
    python test_instagram_live.py <instagram_reel_url>
"""
...
import config
from normalizer.instagram_handler import (
...
logger = logging.getLogger("test_instagram_live")
...
def run_test(url: str):
    ...
    print(f"\n{'='*70}")
    print(f"Instagram Deep Extract Test")
    ...
    # ────── Run 1: MiMo-V2.5 ──────
    print(f"{'─'*70}")
    print(f"RUN 1: MiMo-V2.5 (xiaomi/mimo-v2.5)")
    print(f"{'─'*70}\n")
    ...
    print(f"\n{'─'*70}")
    print(f"RUN 2: Gemini 2.5 Flash Lite (google/gemini-2.5-flash-lite)")
    print(f"{'─'*70}\n")
    ...
    print(f"\n{'='*70}")
    print(f"OUTPUT: Gemini 2.5 Flash Lite")
    print(f"{'='*70}")
